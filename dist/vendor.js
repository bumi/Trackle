!function(e, t) {
    ...
    d = null, k.cssEase = {
        ...
        set: function(s, r) {
            var t = r;
            t instanceof j || (t = new j(t)), s.style[q.transform] = "WebkitTransform" !== q.transform || a ? t.toString() : t.toString(!0), 
    ...
    n("perspective"), n("skewX"), n("skewY"), n("x", !0), n("y", !0), j.prototype = {
        ...
        y = void 0), "undefined" != typeof z.easing && (y = z.easing, delete z.easing), 
        "undefined" != typeof z.duration && (s = z.duration, delete z.duration), "undefined" != typeof z.complete && (C = z.complete, 
        delete z.complete), "undefined" != typeof z.queue && (w = z.queue, delete z.queue), 
        "undefined" != typeof z.delay && (u = z.delay, delete z.delay), "undefined" == typeof s && (s = k.fx.speeds._default), 
        "undefined" == typeof y && (y = k.cssEase._default), s = l(s);
    ...
    var d = a.Model = function(t, e) {
        var i = t || {};
        e || (e = {}), this.cid = h.uniqueId("c"), this.attributes = {}, e.collection && (this.collection = e.collection), 
        e.parse && (i = this.parse(i, e) || {}), i = h.defaults({}, i, h.result(this, "defaults")), 
    ...
    h.extend(d.prototype, o, {
        ...
        save: function(t, e, i) {
            ...
            return i.success = function(t) {
                ...
                void o.trigger("sync", o, t, i));
            }, M(this, i), s = this.isNew() ? "create" : i.patch ? "patch" : "update", "patch" === s && (i.attrs = r), 
    ...
    h.extend(v.prototype, o, {
        ...
        remove: function(t, e) {
            ...
            t = i ? [ t ] : h.clone(t), e || (e = {});
            var r, s, n, a;
            for (r = 0, s = t.length; s > r; r++) a = t[r] = this.get(t[r]), a && (delete this._byId[a.id], 
            delete this._byId[a.cid], n = this.indexOf(a), this.models.splice(n, 1), this.length--, 
            e.silent || (e.index = n, a.trigger("remove", a, this, e)), this._removeReference(a));
            return i ? t[0] : t;
        },
        set: function(t, e) {
            ...
            for (r = 0, s = t.length; s > r; r++) {
                if (o = t[r], n = o instanceof d ? a = o : o[f.prototype.idAttribute], u = this.get(n)) x && (_[u.cid] = !0), 
                b && (o = o === a ? a.attributes : o, e.parse && (o = u.parse(o, e)), u.set(o, e), 
                p && !l && u.hasChanged(v) && (l = !0)), t[r] = u; else if (w) {
            ...
            if (m.length || E && E.length) if (p && (l = !0), this.length += m.length, null != c) for (r = 0, 
            s = m.length; s > r; r++) this.models.splice(c + r, 0, m[r]); else {
    ...
    var w = a.View = function(t) {
        this.cid = h.uniqueId("view"), t || (t = {}), h.extend(this, h.pick(t, x)), this._ensureElement(), 
    ...
    I.started = !1, h.extend(I.prototype, o, {
        ...
        start: function(t) {
            ...
            this.root = ("/" + this.root + "/").replace(O, "/"), r && this._wantsHashChange && (this.iframe = a.$('<iframe src="javascript:0" tabindex="-1" />').hide().appendTo("body")[0].contentWindow, 
            ...
            if (this._wantsHashChange && this._wantsPushState) {
                if (!this._hasPushState && !n) return this.fragment = this.getFragment(null, !0), 
                this.location.replace(this.root + this.location.search + "#" + this.fragment), !0;
                this._hasPushState && n && s.hash && (this.fragment = this.getHash().replace(N, ""), 
    ...
    if ("undefined" != typeof exports && "undefined" != typeof require) var $ = root.jQuery || root.Zepto || root.ender || require("jquery"), _ = root._ || require("underscore"), Backbone = root.Backbone || require("backbone"); else var $ = root.jQuery, _ = root._, Backbone = root.Backbone;
    var Form = Backbone.View.extend({
        initialize: function(options) {
            ...
            var schema = this.schema = function() {
                ...
                return model && model.schema ? _.result(model, "schema") : self.schema ? _.result(self, "schema") : {};
            }();
            _.extend(this, _.pick(options, "model", "data", "idPrefix", "templateData"));
            var constructor = this.constructor;
            this.template = options.template || this.template || constructor.template, this.Fieldset = options.Fieldset || this.Fieldset || constructor.Fieldset, 
            this.Field = options.Field || this.Field || constructor.Field, this.NestedField = options.NestedField || this.NestedField || constructor.NestedField;
            var selectedFields = this.selectedFields = options.fields || _.keys(schema), fields = this.fields = {};
        ...
        createField: function(key, schema) {
            ...
            this.model ? options.model = this.model : options.value = this.data ? this.data[key] : null;
            var field = new this.Field(options);
            return this.listenTo(field.editor, "all", this.handleEditorEvent), field;
        },
        handleEditorEvent: function(event, editor) {
            var formEvent = editor.key + ":" + event;
            switch (this.trigger.call(this, formEvent, this, editor, Array.prototype.slice.call(arguments, 2)), 
            event) {
              case "change":
              ...
              case "blur":
                if (this.hasFocus) {
                    ...
                    setTimeout(function() {
                        ...
                        focusedField || self.trigger("blur", self);
                    }, 0);
                }
            }
        },
        render: function() {
            var self = this, fields = this.fields, $form = $($.trim(this.template(_.result(this, "templateData"))));
            return $form.find("[data-editors]").add($form).each(function(i, el) {
                ...
                _.isUndefined(selection) || _.each(self.fieldsets, function(fieldset) {
                    $container.prepend(fieldset.render().el);
                });
            }), this.setElement($form), $form.addClass(this.className), this;
        },
        validate: function(options) {
            var fields = this.fields, model = this.model, errors = {};
            if (options = options || {}, _.each(fields, function(field) {
                var error = field.validate();
                error && (errors[field.key] = error);
            }), !options.skipModelValidate && model && model.validate) {
                var modelErrors = model.validate(this.getValue());
                if (modelErrors) {
                    var isDictionary = _.isObject(modelErrors) && !_.isArray(modelErrors);
                    isDictionary || (errors._others = errors._others || [], errors._others.push(modelErrors)), 
                    isDictionary && _.each(modelErrors, function(val, key) {
                        if (fields[key] && !errors[key]) fields[key].setError(val), errors[key] = val; else {
                            errors._others = errors._others || [];
                            var tmpErr = {};
                            tmpErr[key] = val, errors._others.push(tmpErr);
                        }
                    });
                }
            }
        ...
        commit: function(options) {
            ...
            var modelError, setOptions = _.extend({
                error: function(model, e) {
                    modelError = e;
                }
            }, options);
            return this.model.set(this.getValue(), setOptions), modelError ? modelError : void 0;
        },
        ...
        setValue: function(prop, val) {
            var data = {};
            "string" == typeof prop ? data[prop] = val : data = prop;
            var key;
            for (key in this.schema) void 0 !== data[key] && this.fields[key].setValue(data[key]);
        },
        ...
        focus: function() {
            if (!this.hasFocus) {
                var fieldset = this.fieldsets[0], field = fieldset.getFieldAt(0);
                field && field.editor.focus();
            }
        },
        blur: function() {
            if (this.hasFocus) {
        ...
        trigger: function(event) {
            return "focus" === event ? this.hasFocus = !0 : "blur" === event && (this.hasFocus = !1), 
            Backbone.View.prototype.trigger.apply(this, arguments);
        },
        remove: function() {
            return _.each(this.fieldsets, function(fieldset) {
                fieldset.remove();
        ...
        template: _.template("    <form data-fieldsets></form>  ", null, this.templateSettings),
        templateSettings: {
            evaluate: /<%([\s\S]+?)%>/g,
            interpolate: /<%=([\s\S]+?)%>/g,
            escape: /<%-([\s\S]+?)%>/g
    ...
    Form.validators = function() {
        ...
        return validators.errMessages = {
            ...
            return options = _.extend({
                ...
                return null === value || void 0 === value || value === !1 || "" === value ? err : void 0;
            };
            ...
            return options = _.extend({
                ...
                if (null !== value && void 0 !== value && "" !== value) return "string" == typeof options.regexp && (options.regexp = new RegExp(options.regexp, options.flags)), 
                (options.match ? !options.regexp.test(value) : options.regexp.test(value)) ? err : void 0;
            };
            ...
            }, options), validators.regexp(options);
            ...
            }, options), function(value, attrs) {
                options.value = value;
                var err = {
                    type: options.type,
                    message: _.isFunction(options.message) ? options.message(options) : options.message
                };
                if (null !== value && void 0 !== value && "" !== value) return value !== attrs[options.field] ? err : void 0;
            };
        }, validators;
        ...
        initialize: function(options) {
            ...
            this.fields = _.pick(options.fields, schema.fields), this.template = options.template || schema.template || this.template || this.constructor.template;
        },
        createSchema: function(schema) {
            return _.isArray(schema) && (schema = {
                fields: schema
            }), schema.legend = schema.legend || null, schema;
        },
        ...
        render: function() {
            var fields = (this.schema, this.fields), $fieldset = $($.trim(this.template(_.result(this, "templateData"))));
            return $fieldset.find("[data-fields]").add($fieldset).each(function(i, el) {
                var $container = $(el), selection = $container.attr("data-fields");
                _.isUndefined(selection) || _.each(fields, function(field) {
                    $container.append(field.render().el);
                });
            }), this.setElement($fieldset), this;
        },
        remove: function() {
            _.each(this.fields, function(field) {
                field.remove();
        ...
        initialize: function(options) {
            options = options || {}, _.extend(this, _.pick(options, "form", "key", "model", "value", "idPrefix"));
            var schema = this.schema = this.createSchema(options.schema);
        ...
        createSchema: function(schema) {
            ...
            }, schema), schema.type = _.isString(schema.type) ? Form.editors[schema.type] : schema.type, 
            schema;
        },
        ...
        createEditorId: function() {
            ...
            return id = id.replace(/\./g, "_"), _.isString(prefix) || _.isNumber(prefix) ? prefix + id : _.isNull(prefix) ? id : this.model ? this.model.cid + "_" + id : id;
        },
        createTitle: function() {
            var str = this.key;
            return str = str.replace(/([A-Z])/g, " $1"), str = str.replace(/^./, function(str) {
        ...
        render: function() {
            var schema = this.schema, editor = this.editor;
            if (schema.type == Form.editors.Hidden) return this.setElement(editor.render().el);
            var $field = $($.trim(this.template(_.result(this, "templateData"))));
            return schema.fieldClass && $field.addClass(schema.fieldClass), schema.fieldAttrs && $field.attr(schema.fieldAttrs), 
            $field.find("[data-editor]").add($field).each(function(i, el) {
                var $container = $(el), selection = $container.attr("data-editor");
                _.isUndefined(selection) || $container.append(editor.render().el);
            }), this.setElement($field), this;
        },
        validate: function() {
            var error = this.editor.validate();
            return error ? this.setError(error.message) : this.clearError(), error;
        },
        setError: function(msg) {
            this.editor.hasNestedForm || (this.$el.addClass(this.errorClassName), this.$("[data-error]").html(msg));
        },
        clearError: function() {
        ...
        remove: function() {
            this.editor.remove(), Backbone.View.prototype.remove.call(this);
        }
    }, {
        template: _.template('    <div>      <label for="<%= editorId %>"><%= title %></label>      <div>        <span data-editor></span>        <div data-error></div>        <div><%= help %></div>      </div>    </div>  ', null, Form.templateSettings),
        errorClassName: "error"
    }), Form.NestedField = Form.Field.extend({
        template: _.template($.trim("    <div>      <span data-editor></span>      <% if (help) { %>        <div><%= help %></div>      <% } %>      <div data-error></div>    </div>  "), null, Form.templateSettings)
        ...
        initialize: function(options) {
            ...
            if (options.model) {
                ...
                this.model = options.model, this.value = this.model.get(options.key);
            } else void 0 !== options.value && (this.value = options.value);
            void 0 === this.value && (this.value = this.defaultValue), _.extend(this, _.pick(options, "key", "form"));
            var schema = this.schema = options.schema || {};
            this.validators = options.validators || schema.validators, this.$el.attr("id", this.id), 
            this.$el.attr("name", this.getName()), schema.editorClass && this.$el.addClass(schema.editorClass), 
            schema.editorAttrs && this.$el.attr(schema.editorAttrs);
        },
        getName: function() {
            var key = this.key || "";
        ...
        commit: function(options) {
            ...
            return error ? error : (this.listenTo(this.model, "invalid", function(model, e) {
                error = e;
            }), this.model.set(this.key, this.getValue(), options), error ? error : void 0);
        },
        validate: function() {
            var error = (this.$el, null), value = this.getValue(), formValues = this.form ? this.form.getValue() : {}, validators = this.validators, getValidator = this.getValidator;
            return validators && _.every(validators, function(validator) {
                return error = getValidator(validator)(value, formValues), error ? !1 : !0;
            }), error;
        },
        trigger: function(event) {
            return "focus" === event ? this.hasFocus = !0 : "blur" === event && (this.hasFocus = !1), 
        ...
        getValidator: function(validator) {
            ...
            if (_.isRegExp(validator)) return validators.regexp({
                regexp: validator
            });
        ...
        initialize: function(options) {
            ...
            var schema = this.schema, type = "text";
            schema && schema.editorAttrs && schema.editorAttrs.type && (type = schema.editorAttrs.type), 
            schema && schema.dataType && (type = schema.dataType), this.$el.attr("type", type);
        },
        render: function() {
            return this.setValue(this.value), this;
        },
        determineChange: function() {
            var currentValue = this.$el.val(), changed = currentValue !== this.previousValue;
            changed && (this.previousValue = currentValue, this.trigger("change", this));
        },
        getValue: function() {
            return this.$el.val();
        },
        ...
        initialize: function(options) {
            Form.editors.Text.prototype.initialize.call(this, options), this.$el.attr("type", "password");
        }
        ...
        initialize: function(options) {
            ...
            var schema = this.schema;
            this.$el.attr("type", "number"), schema && schema.editorAttrs && schema.editorAttrs.step || this.$el.attr("step", "any");
        },
        onKeyPress: function(event) {
            ...
            if (0 === event.charCode) return void delayedDetermineChange();
            var newVal = this.$el.val();
            void 0 != event.charCode && (newVal += String.fromCharCode(event.charCode));
            var numeric = /^[0-9]*\.?[0-9]*?$/.test(newVal);
            numeric ? delayedDetermineChange() : event.preventDefault();
        },
        getValue: function() {
        ...
        setValue: function(value) {
            value = function() {
                return _.isNumber(value) ? value : _.isString(value) && "" !== value ? parseFloat(value, 10) : null;
            }(), _.isNaN(value) && (value = null), Form.editors.Text.prototype.setValue.call(this, value);
        }
    }), Form.editors.Hidden = Form.editors.Text.extend({
        defaultValue: "",
        initialize: function(options) {
            Form.editors.Text.prototype.initialize.call(this, options), this.$el.attr("type", "hidden");
        },
        focus: function() {},
        blur: function() {}
        ...
        initialize: function(options) {
            Form.editors.Base.prototype.initialize.call(this, options), this.$el.attr("type", "checkbox");
        },
        render: function() {
            return this.setValue(this.value), this;
        },
        ...
        setValue: function(value) {
            value ? this.$el.prop("checked", !0) : this.$el.prop("checked", !1);
        },
        focus: function() {
            this.hasFocus || this.$el.focus();
        },
        ...
        initialize: function(options) {
            if (Form.editors.Base.prototype.initialize.call(this, options), !this.schema || !this.schema.options) throw new Error("Missing required 'schema.options'");
        },
        render: function() {
        ...
        setOptions: function(options) {
            ...
            if (options instanceof Backbone.Collection) {
                ...
                collection.length > 0 ? this.renderOptions(options) : collection.fetch({
                    success: function() {
                        self.renderOptions(options);
                    }
                });
            } else _.isFunction(options) ? options(function(result) {
                self.renderOptions(result);
            }, self) : this.renderOptions(options);
        },
        renderOptions: function(options) {
            var html, $select = this.$el;
            html = this._getOptionsHtml(options), $select.html(html), this.setValue(this.value);
        },
        _getOptionsHtml: function(options) {
            var html;
            if (_.isString(options)) html = options; else if (_.isArray(options)) html = this._arrayToHtml(options); else if (options instanceof Backbone.Collection) html = this._collectionToHtml(options); else if (_.isFunction(options)) {
                var newOptions;
                options(function(opts) {
                    newOptions = opts;
                }, this), html = this._getOptionsHtml(newOptions);
            } else html = this._objectToHtml(options);
            return html;
        },
        getValue: function() {
            return this.$el.val();
        ...
        _objectToHtml: function(obj) {
            var array = [];
            for (var key in obj) obj.hasOwnProperty(key) && array.push({
                val: key,
                label: obj[key]
            });
            var html = this._arrayToHtml(array);
        ...
        _arrayToHtml: function(array) {
            var html = [];
            return _.each(array, function(option) {
                if (_.isObject(option)) if (option.group) html.push('<optgroup label="' + option.group + '">'), 
                html.push(this._getOptionsHtml(option.options)), html.push("</optgroup>"); else {
                    var val = option.val || 0 === option.val ? option.val : "";
        ...
        events: {
            ...
            "blur input[type=radio]": function() {
                if (this.hasFocus) {
                    var self = this;
                    setTimeout(function() {
                        self.$("input[type=radio]:focus")[0] || self.trigger("blur", self);
                    }, 0);
                }
            }
        },
        ...
        focus: function() {
            if (!this.hasFocus) {
                ...
                return checked[0] ? void checked.focus() : void this.$("input[type=radio]").first().focus();
            }
        },
        blur: function() {
        ...
        _arrayToHtml: function(array) {
            var self = this, template = this.getTemplate(), name = self.getName(), id = self.id, items = _.map(array, function(option, index) {
                var item = {
                    name: name,
                    id: id + "-" + index
                };
                return _.isObject(option) ? (item.value = option.val || 0 === option.val ? option.val : "", 
                item.label = option.label) : (item.value = option, item.label = option), item;
            });
            return template({
                items: items
            });
        ...
        template: _.template('    <ul>      <% _.each(items, function(item) { %>        <li>          <input type="radio" name="<%= item.name %>" value="<%= item.value %>" id="<%= item.id %>" />          <label for="<%= item.id %>"><%= item.label %></label>        </li>      <% }); %>    </ul>  ', null, Form.templateSettings)
        ...
        events: {
            ...
            "blur input[type=checkbox]": function() {
                if (this.hasFocus) {
                    var self = this;
                    setTimeout(function() {
                        self.$("input[type=checkbox]:focus")[0] || self.trigger("blur", self);
                    }, 0);
                }
            }
        },
        ...
        setValue: function(values) {
            _.isArray(values) || (values = [ values ]), this.$("input[type=checkbox]").val(values);
        },
        focus: function() {
        ...
        _arrayToHtml: function(array) {
            var html = [], self = this;
            return _.each(array, function(option, index) {
                var itemHtml = "<li>", close = !0;
                if (_.isObject(option)) if (option.group) {
                    var originalId = self.id;
                    self.id += "-" + self.groupNumber++, itemHtml = '<fieldset class="group"> <legend>' + option.group + "</legend>", 
                    itemHtml += self._arrayToHtml(option.options), itemHtml += "</fieldset>", self.id = originalId, 
                    close = !1;
                } else {
                    var val = option.val || 0 === option.val ? option.val : "";
                    itemHtml += '<input type="checkbox" name="' + self.getName() + '" value="' + val + '" id="' + self.id + "-" + index + '" />', 
                    itemHtml += '<label for="' + self.id + "-" + index + '">' + option.label + "</label>";
                } else itemHtml += '<input type="checkbox" name="' + self.getName() + '" value="' + option + '" id="' + self.id + "-" + index + '" />', 
                itemHtml += '<label for="' + self.id + "-" + index + '">' + option + "</label>";
                close && (itemHtml += "</li>"), html.push(itemHtml);
            }), html.join("");
        }
    }), Form.editors.Object = Form.editors.Base.extend({
        hasNestedForm: !0,
        initialize: function(options) {
            if (this.value = {}, Form.editors.Base.prototype.initialize.call(this, options), 
            !this.form) throw new Error('Missing required option "form"');
            if (!this.schema.subSchema) throw new Error("Missing required 'schema.subSchema' option for Object editor");
        },
        render: function() {
            var NestedForm = this.form.constructor;
            return this.nestedForm = new NestedForm({
                schema: this.schema.subSchema,
                data: this.value,
                idPrefix: this.id + "_",
                Field: NestedForm.NestedField
            }), this._observeFormEvents(), this.$el.html(this.nestedForm.render().el), this.hasFocus && this.trigger("blur", this), 
            this;
        },
        getValue: function() {
        ...
        remove: function() {
            this.nestedForm.remove(), Backbone.View.prototype.remove.call(this);
        },
        validate: function() {
        ...
        _observeFormEvents: function() {
            this.nestedForm && this.nestedForm.on("all", function() {
                ...
                args[1] = this, this.trigger.apply(this, args);
            }, this);
        }
    }), Form.editors.NestedModel = Form.editors.Object.extend({
        initialize: function(options) {
            if (Form.editors.Base.prototype.initialize.call(this, options), !this.form) throw new Error('Missing required option "form"');
            if (!options.schema.model) throw new Error('Missing required "schema.model" option for NestedModel editor');
        },
        render: function() {
            var NestedForm = this.form.constructor, data = this.value || {}, nestedModel = (this.key, 
            this.schema.model), modelInstance = data.constructor === nestedModel ? data : new nestedModel(data);
            return this.nestedForm = new NestedForm({
                model: modelInstance,
                idPrefix: this.id + "_",
        ...
        commit: function() {
            ...
            return error ? (this.$el.addClass("error"), error) : Form.editors.Object.prototype.commit.call(this);
        }
        ...
        events: {
            ...
            "blur select": function() {
                if (this.hasFocus) {
                    var self = this;
                    setTimeout(function() {
                        self.$("select:focus")[0] || self.trigger("blur", self);
                    }, 0);
                }
            }
        },
        initialize: function(options) {
            options = options || {}, Form.editors.Base.prototype.initialize.call(this, options);
            var Self = Form.editors.Date, today = new Date();
            if (this.options = _.extend({
                monthNames: Self.monthNames,
                showMonthNames: Self.showMonthNames
            }, options), this.schema = _.extend({
                yearStart: today.getFullYear() - 100,
                yearEnd: today.getFullYear()
            }, options.schema || {}), this.value && !_.isDate(this.value) && (this.value = new Date(this.value)), 
            !this.value) {
                var date = new Date();
                date.setSeconds(0), date.setMilliseconds(0), this.value = date;
            }
            this.template = options.template || this.constructor.template;
        },
        render: function() {
            var options = this.options, schema = this.schema, datesOptions = _.map(_.range(1, 32), function(date) {
            ...
            }), yearRange = schema.yearStart < schema.yearEnd ? _.range(schema.yearStart, schema.yearEnd + 1) : _.range(schema.yearStart, schema.yearEnd - 1, -1), yearsOptions = _.map(yearRange, function(year) {
            ...
            return this.$date = $el.find('[data-type="date"]'), this.$month = $el.find('[data-type="month"]'), 
            this.$year = $el.find('[data-type="year"]'), this.$hidden = $('<input type="hidden" name="' + this.key + '" />'), 
            $el.append(this.$hidden), this.setValue(this.value), this.setElement($el), this.$el.attr("id", this.id), 
            this.$el.attr("name", this.getName()), this.hasFocus && this.trigger("blur", this), 
            this;
        },
        getValue: function() {
            var year = this.$year.val(), month = this.$month.val(), date = this.$date.val();
            return year && month && date ? new Date(year, month, date) : null;
        },
        setValue: function(date) {
            this.$date.val(date.getDate()), this.$month.val(date.getMonth()), this.$year.val(date.getFullYear()), 
            this.updateHidden();
        },
        focus: function() {
        ...
        updateHidden: function() {
            ...
            _.isDate(val) && (val = val.toISOString()), this.$hidden.val(val);
        }
    }, {
        ...
        initialize: function(options) {
            ...
            this.options = _.extend({
                ...
                minsInterval: 15
            }, options.schema || {}), this.dateEditor = new this.options.DateEditor(options), 
            this.value = this.dateEditor.value, this.template = options.template || this.constructor.template;
        },
        render: function() {
            function pad(n) {
                return 10 > n ? "0" + n : n;
            }
            var schema = this.schema, hoursOptions = _.map(_.range(0, 24), function(hour) {
            ...
            return $el.find("[data-date]").append(this.dateEditor.render().el), this.$hour = $el.find('select[data-type="hour"]'), 
            this.$min = $el.find('select[data-type="min"]'), this.$hidden = $el.find('input[type="hidden"]'), 
            this.setValue(this.value), this.setElement($el), this.$el.attr("id", this.id), this.$el.attr("name", this.getName()), 
            this.hasFocus && this.trigger("blur", this), this;
        },
        getValue: function() {
            var date = this.dateEditor.getValue(), hour = this.$hour.val(), min = this.$min.val();
            return date && hour && min ? (date.setHours(hour), date.setMinutes(min), date) : null;
        },
        setValue: function(date) {
            _.isDate(date) || (date = new Date(date)), this.dateEditor.setValue(date), this.$hour.val(date.getHours()), 
            this.$min.val(date.getMinutes()), this.updateHidden();
        },
        focus: function() {
            this.hasFocus || this.$("select").first().focus();
        },
        ...
        remove: function() {
            this.dateEditor.remove(), Form.editors.Base.prototype.remove.call(this);
        }
    }, {
    ...
    }), Form.VERSION = "0.14.0", Backbone.Form = Form, "undefined" != typeof exports && (exports = Form);
}(window || global || this), function(Form) {
    Form.template = _.template('    <form class="form-horizontal" role="form" data-fieldsets>      <fieldset>        <div class="form-group">          <input class="form-control" type="submit" value="Log In">        </div>      </fieldset>    </form>  '), 
    Form.Fieldset.template = _.template("    <fieldset data-fields>      <% if (legend) { %>        <legend><%= legend %></legend>      <% } %>    </fieldset>  "), 
    Form.Field.template = _.template('    <div class="form-group field-<%= key %>">      <label class="col-sm-2 control-label" for="<%= editorId %>"><%= title %></label>      <div class="col-sm-10">        <span data-editor></span>        <span class="help-block" data-error></span>        <span class="help-block"><%= help %></span>      </div>    </div>  '), 
    ...
    Form.editors.Base.prototype.className = "form-control", Form.Field.errorClassName = "has-error", 
    Form.editors.List && (Form.editors.List.template = _.template('      <div class="bbf-list">        <ul class="list-unstyled clearfix" data-items></ul>        <button type="button" class="btn bbf-add" data-action="add">Add</button>      </div>    '), 
...
}(Backbone.Form), Backbone.ChildViewContainer = function(a, b) {
    var c = function(a) {
...
var Marionette = function(a, b, c) {
    ...
    return f.extend = b.Model.extend, f.getOption = function(a, b) {
        ...
        buildRegion: function(a, b) {
            ...
            var h, i;
            d && (h = a), a.selector && (h = a.selector, delete a.selector), g && (i = a), !g && f && (i = b), 
        ...
        close: function() {
            ...
            a && !a.isClosed && (a.close ? a.close() : a.remove && a.remove(), f.triggerMethod.call(this, "close", a), 
        ...
        constructor: function(a) {
            ...
            this.options = c.extend({}, c.result(this, "options"), c.isFunction(a) ? a.call(this) : a), 
            this.events = this.normalizeUIKeys(c.result(this, "events")), b.View.prototype.constructor.apply(this, d), 
            f.MonitorDOMRefresh(this), this.listenTo(this, "show", this.onShowCalled, this);
        },
        ...
        addItemView: function(a, b, d) {
            ...
            this.children.add(g), this.renderItemView(g, d), this._isShown && !this.isBuffering && f.triggerMethod.call(g, "show"), 
        ...
        addChildViewEventForwarding: function(a) {
            ...
            this.listenTo(a, "all", function() {
                ...
                e[0] = b + ":" + g, e.splice(1, 0, a), "undefined" != typeof h && c.isFunction(h[g]) && h[g].apply(this, e), 
                f.triggerMethod.apply(this, e);
            }, this);
        },
...
(function(a) {
    ...
    "object" == typeof exports ? module.exports = factory(require("moment")) : "function" == typeof define && define.amd ? define("moment-range", [ "moment" ], factory) : root.moment = factory(root.moment);
}(this, function(moment) {
    var DateRange;
    return DateRange = function() {
        function DateRange(start, end) {
            this.start = moment(start), this.end = moment(end);
        }
        return DateRange.prototype.contains = function(other) {
            return other instanceof DateRange ? this.start < other.start && this.end > other.end : this.start <= other && other <= this.end;
        }, DateRange.prototype._by_string = function(interval, hollaback) {
            var current, _results;
            for (current = moment(this.start), _results = []; this.contains(current); ) hollaback.call(this, current.clone()), 
            _results.push(current.add(interval, 1));
            return _results;
        }, DateRange.prototype._by_range = function(range_interval, hollaback) {
            var i, l, _i, _results;
            if (l = Math.round(this / range_interval), 1/0 === l) return this;
            for (_results = [], i = _i = 0; l >= 0 ? l >= _i : _i >= l; i = l >= 0 ? ++_i : --_i) _results.push(hollaback.call(this, moment(this.start.valueOf() + range_interval.valueOf() * i)));
            return _results;
        }, DateRange.prototype.overlaps = function(range) {
            var _ref, _ref1;
            return this.start < (_ref = range.start) && _ref < this.end ? !0 : range.start < (_ref1 = this.start) && _ref1 < range.end ? !0 : !1;
        }, DateRange.prototype.by = function(range, hollaback) {
            return "string" == typeof range ? this._by_string(range, hollaback) : this._by_range(range, hollaback), 
            this;
        ...
        return [ "year", "month", "week", "day", "hour", "minute", "second" ].indexOf(start) > -1 ? new DateRange(moment(this).startOf(start), moment(this).endOf(start)) : new DateRange(start, end);

!function(e, t) {
    ...
    Form.template = _.template('    <form class="form-horizontal" role="form" data-fieldsets>      <div class="form-group">        <input class="form-control" type="submit" value="Ok">      </div>    </form>  '), 
